...
Image1 = []
for yr in years:
    Image1.append(ee.Image(root + '/synop' + str(yr)))

synopt_prev = ee.List(Image1)
...
for m in range(0, len(years)):
    ...
    task = ee.batch.Export.image.toAsset(image=leaf, description=str(yr),
