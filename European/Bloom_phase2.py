...
# data = 'users/Emma/E_Obs/'  # 'NASA/ORNL/DAYMET_V3'   'IDAHO_EPSCOR/GRIDMET'   'IDAHO_EPSCOR/MACAv2_METDATA'
scl = 1000  # 4638.23937 27829.87269831839

Leaf_folder = 'LeafEuropean'
folder_puentea = 'puenteaEurope'
folder = 'BloomEuropean_2'

bandmaxT = 1
bandminT = 2

rootLeaf = user + Leaf_folder
rootpuentea = user + folder_puentea
...
Image21 = []
for yr in years:
    Image11.append(ee.Image(rootpuentea + '/aGDH' + str(yr)))
    Image21.append(ee.Image(rootLeaf + '/' + str(yr)))

acgdh_prev = ee.List(Image11)
leaf = ee.List(Image21)
